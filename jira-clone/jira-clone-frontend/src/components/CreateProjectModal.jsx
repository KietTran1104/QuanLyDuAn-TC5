      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ padding: '24px', flex: 1 }}>
          ...
          <div style={{ marginBottom: '24px' }}>
            <label style={{ display: 'block', fontSize: '12px', fontWeight: 'bold', color: '#5E6C84', marginBottom: '8px' }}>Mã PIN bảo mật (4 chữ số - Tùy chọn)</label>
            <input 
              type="text" 
              maxLength="4"
              ...
              style={{ width: '100%', padding: '8px 12px', borderRadius: '3px', border: '2px solid #DFE1E6', fontSize: '14px', outline: 'none' }}
            />
            <p style={{ margin: '4px 0 0', fontSize: '11px', color: '#6B778C' }}>Nếu đặt mã PIN, người dùng sẽ phải nhập đúng mã này mới có thể vào xem dự án.</p>
          </div>
