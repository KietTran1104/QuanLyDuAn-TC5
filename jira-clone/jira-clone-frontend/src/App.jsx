...
function AppContent() {
  ...
  return (
    <Routes>
      ...
      <Route path="/projects/:id/board" element={auth ? <ProjectGuard><BoardPage onLogout={handleLogout} /></ProjectGuard> : <Navigate to="/login" />} />
      <Route path="/projects/:id/backlog" element={auth ? <ProjectGuard><BacklogPage onLogout={handleLogout} /></ProjectGuard> : <Navigate to="/login" />} />
      <Route path="/projects/:id/settings" element={auth ? <ProjectGuard><ProjectSettingsPage onLogout={handleLogout} /></ProjectGuard> : <Navigate to="/login" />} />
      <Route path="/projects/:id/reports" element={auth ? <ProjectGuard><ProjectReportsPage onLogout={handleLogout} /></ProjectGuard> : <Navigate to="/login" />} />
      <Route path="/projects/:id/timeline" element={auth ? <ProjectGuard><ProjectTimelinePage onLogout={handleLogout} /></ProjectGuard> : <Navigate to="/login" />} />
